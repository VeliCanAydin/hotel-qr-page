  ...
  worksheet.addRows(
    feedbacks.map((feedback) => {
      ...
      return {
        ...
        cleanliness: feedback.cleanlinessRating != null ? `${feedback.cleanlinessRating}/5` : '-',
        staff: feedback.staffRating != null ? `${feedback.staffRating}/5` : '-',
        comfort: feedback.comfortRating != null ? `${feedback.comfortRating}/5` : '-',
        value: feedback.valueRating != null ? `${feedback.valueRating}/5` : '-',
        food: feedback.foodRating != null ? `${feedback.foodRating}/5` : '-',
