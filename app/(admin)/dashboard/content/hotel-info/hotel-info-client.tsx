...
import { updateHotelInfo, type HotelInfoData } from "@/lib/actions/hotel-info"

export default function HotelInfoClient({ initialData }: { initialData: HotelInfoData }) {
  const [form, setForm] = useState(initialData)

  function set(key: keyof HotelInfoData) {
    return (e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement>) =>
      setForm((p) => ({ ...p, [key]: e.target.value }))
  }

  function handleSave() {
    toast.promise(updateHotelInfo(form), {
      loading: "Saving...",
      success: "Hotel information saved",
