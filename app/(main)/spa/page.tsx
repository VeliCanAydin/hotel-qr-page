    ...
    <div className="min-h-screen">
      ...
      <div className="flex flex-col p-4 gap-4">
        <p className="text-muted-foreground text-lg leading-relaxed">
          You will experience one of the most precious moments of your holiday at Dosinia Spa. With
          its professional team, excellent hygiene environment and quality spa products, you can
          relax and start your future moments by feeling refreshed and great.
        </p>
